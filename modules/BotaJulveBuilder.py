...
class BotaJulveBuilder(QObject):
    ...
    def __init__(self, gpkg_path):
        ...
        self.output_path = os.path.join(self.output_dir, "bota_julve.csv")
    ...
    def run(self, layer_config):
        ...
        # 4. Export CSV
        self.status_changed.emit("Export bota_julve.csv...")
        ...
        self.status_changed.emit("bota_julve.csv enregistré.")
        return True, (
